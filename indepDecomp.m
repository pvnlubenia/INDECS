...
%    reaction network (CRN), if it exists. If no such decomposition exists, %
%    a message appears saying so. The output variables 'model', 'R', 'G',   %
%    and 'P' allow the user to view the following, respectively:            %
...
function [model, R, G, P] = indepDecomp(model)
